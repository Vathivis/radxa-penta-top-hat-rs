...
unsupported button action names. Timer values must be finite and between 0 and 31,536,000 seconds
(365 days), inclusive. A missing OLED device disables only
